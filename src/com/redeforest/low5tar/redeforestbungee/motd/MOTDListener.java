...
public class MOTDListener implements Listener {
	...
	public static void aoPingar(ProxyPingEvent e) {
		...
		ServerPing.PlayerInfo[] pi = { new ServerPing.PlayerInfo("§ewww.redeforest.com", "1") };
		p = new ServerPing.Players(500, p.getOnline(), pi);
		String motd = getBaixo().replace("&", "§");
		ServerPing ping = new ServerPing(r.getVersion(), p, "&b&lREDE FOREST &f⚡ &7Versão 1.8".replace("&", "§") + "\n" + motd, r.getFaviconObject());
		if (taManuGlobal()) {
	...
	public static void adicionarDados() {
		String baixopadrao = "§ewww.redeforest.com";
		try {
